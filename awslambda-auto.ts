...
let awsLambdaInstrumentation = new AwsLambdaInstrumentation(typeof configureLambdaInstrumentation === 'function' ? configureLambdaInstrumentation({}) : {});
...
async function initializeProvider() {
  ...
  config.idGenerator = new AWSXRayIdGenerator();
